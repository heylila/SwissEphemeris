...
final class PlutoRetrograde: XCTestCase {

    override func setUpWithError() throws {
        JPLFileManager.setEphemerisPath()
    }

    //2022-04-29 to 2022-10-08
    func testPlutoRetrograde() throws {
        ...
        // 2022-04-29 to 2022-10-08
        XCTAssert(past.component(.month)! == 4, "Erroneoes Rx starting month is \(past.component(.month)!)")
        XCTAssert(past.component(.day)! == 29, "Erroneoes Rx starting day is \(past.component(.day)!)")
        ...
        XCTAssert(future.component(.day)! == 8, "Erroneoes Rx ending day is \(future.component(.day)!)")
