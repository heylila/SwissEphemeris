...
final class PlutoRetrograde: XCTestCase {
    ...
    func testPlutoRetrograde() throws {
        ...
        // 2022-04-29 to 2022-10-08
        XCTAssert(minuteRxStart.component(.month)! == 4)
        XCTAssert(minuteRxStart.component(.day)! == 29)
        XCTAssert(minuteRxStart.component(.year)! == 2022)

        XCTAssert(minuteRxEnd.component(.month)! == 10)
        XCTAssert(minuteRxEnd.component(.day)! == 8)
