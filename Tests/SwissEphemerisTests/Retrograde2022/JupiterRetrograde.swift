...
final class JupiterRetrograde: XCTestCase {
    ...
    func testJupiterRetrograde() throws {
        ...
        // 2022-05-10 to 2022-11-23
        XCTAssert(minuteRxStart.component(.month)! == 5)
        XCTAssert(minuteRxStart.component(.day)! == 10)
        XCTAssert(minuteRxStart.component(.year)! == 2022)

        XCTAssert(minuteRxEnd.component(.month)! == 11)
