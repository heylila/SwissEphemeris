...
final class SaturnRetrograde: XCTestCase {
    ...
    func testSaturnRetrograde() throws {
        ...
        for i in stride(from: sliceIndex, to: slices.endIndex, by: 1) {
            ...
            let window = findRetrogradeDates(target: Planet.saturn.celestialObject, past, future, time)
        ...
        XCTAssert(past.component(.day)! == 4, "Erroneoes Rx starting day is \(past.component(.day)!)")
