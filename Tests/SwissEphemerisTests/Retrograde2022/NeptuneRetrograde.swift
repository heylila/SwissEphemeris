...
final class NeptuneRetrograde: XCTestCase {
    ...
    func testNeptuneRetrograde() throws {
        ...
        for i in stride(from: sliceIndex, to: slices.endIndex, by: 1) {
            ...
            let window = findRetrogradeDates(target: Planet.neptune.celestialObject, past, future, time)
        ...
        XCTAssert(future.component(.day)! == 3, "Erroneoes Rx ending day is \(future.component(.day)!)")
