//
//  ClevelandOHTests.swift
//  
//
//  Created by Sam Krishna on 3/12/22.
//
...
class ClevelandOHTests: XCTestCase {
    ...
    static var testStartDate: Date {
        return Date(fromString: "2022-03-12 11:25:00 -0800", format: .cocoaDateTime, timeZone: .utc)!
    }
    ...
    func testClevelandOHConjunctions() throws {
        let daysOut = 7
        ...
        print("With a birth chart of \(LilaMock.date) at Cleveland, OH, USA")
